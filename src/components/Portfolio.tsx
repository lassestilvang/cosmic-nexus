...
const projects: Project[] = [
  {
    ...
    description: 'A futuristic e-commerce platform with AI-powered recommendations and holographic product displays.',
  ...
  },
  {
    ...
    description: 'Educational tool for simulating quantum algorithms with interactive circuit builder.',
  ...
  },
  {
    ...
    description: 'Real-time analytics dashboard with organic-inspired UI and particle effects.',
  ...
  },
  {
    ...
    description: 'Generative art platform using machine learning to create cosmic-inspired artwork.',
  ...
  },
  {
    ...
    description: 'Collaborative platform for planning and visualizing space missions with 3D orbital mechanics.',
...
const categories = ['All', 'Web Development', 'Data Visualization', 'AI/ML', 'Education'];
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        >
          ...
          <p className="text-xl text-neon-cyan/80 max-w-2xl mx-auto">
            Explore my journey through the cosmos of technology, where innovation meets imagination.
          </p>
        </motion.div>
        ...
        {filteredProjects.length === 0 && (
          ...
          >
            <p className="text-neon-cyan/60 text-lg">No projects found in this category.</p>
          </motion.div>
        )}
      </div>
    </div>
